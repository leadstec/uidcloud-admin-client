...
/**
  A function to execute predetermined uidcloud email actions.
  @param {string} realmName - The name of the realm(not the realmID) - ex: master,
  @param {string} userId - The id of user
  @param {object} [options] - The options object
  @param {string} [options.clientId] - The client ID that must be set in case of a redirect after actions
  @param {string} [options.redirectUri] - The redirect URI after the user has completed the required actions on the UidCloud server. If this variable is set, it must be a valid redirect URI for the specified clientId variable, and the clientId variable MUST be set
