...
/**
  ...
  @param {object} client - The JSON representation of a client - client_id must be unique
...
function installation (client) {
  return function installation (realmName, id) {
    return new Promise((resolve, reject) => {
      ...
      req.url = `${client.baseUrl}/admin/realms/${realmName}/clients/${id}/installation/providers/uidcloud-oidc-uidcloud-json`;
