...
/**
  Requests a new UidCloud Access Token
  @param {string} baseUrl - The baseurl for the UidCloud server - ex: http://localhost:8080/auth,
  ...
  const tokenRequester = require('./request-token')
